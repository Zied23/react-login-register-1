   ...
   return (
       <div style={{maxWidth:"550px",margin:"0px auto"}}>
           ...
           <div style={{
               ...
               <div>
                       <div className="row">
                           <div className="col-sm-6 col-md-8"><i>{ProfileUser?ProfileUser.name:"loading"}</i>
                           <h5>{ProfileUser?ProfileUser.email:"loading"}</h5>
                   <div style={{display:"flex",justifyContent:"space-between",width:"108%"}}>
                   <i>{renderCardsv.length} Publications</i>
{/*               
                   <h6>12 followers</h6>
                       <h6>0 following</h6> */}
